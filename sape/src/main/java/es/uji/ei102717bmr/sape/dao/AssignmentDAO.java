...
public class AssignmentDAO {
	...
	public void updateAssignmentState(String nifStudent, boolean state) {
	...
	public void deleteAssignment(String nifStudent) {
		this.jdbcTemplate.update("delete from Assignment where nif_Student = ?;", 
				nifStudent);
	}
